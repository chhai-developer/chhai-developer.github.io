...
cls
color 07
title  Microsoft License Activation Tools 1.8
mode 76, 30
...
echo:
call :_color2 %_White% "                       	        " %_Green% "License Tools"
echo:       ______________________________________________________________
echo:
echo:             [1] License Windows Lifetime
echo:             [2] License Windows 2038 Year
echo:             [3] License Windows and Office 180 Days    
echo:             [4] License Status
echo:             [5] Window Troubleshoot
echo:             [6] Additional Tools
echo:             [7] License IDM Lifetime
echo:             [8] WP Injector - Wifi Passwords Injector
echo:             [9] Contact to developer
...
if %_erl%==9 start https://chhai-developer.github.io & goto :MainMenu
if %_erl%==8 setlocal & call :wps               & cls & endlocal & goto :MainMenu
if %_erl%==7 setlocal & call :idm               & cls & endlocal & goto :MainMenu
if %_erl%==6 goto:Extras & goto :MainMenu
...
echo:       ______________________________________________________________
echo:                                                            
echo:             [1] HWID Window License lifetime
echo:             [2] KMS38 Office License 180 Days
echo:             [3] Online KMS License      
echo:             [4] HWID  ^(Windows^) ^+ Online KMS ^(Office^) Lifetime
echo:             [5] KMS38 ^(Windows^) ^+ Online KMS ^(Office^) 180 Days
...
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "                       	   " %_Green% "KMS38 Activation"
echo:       ______________________________________________________________
echo:
...
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "                       	      " %_Green% "Online KMS License"
echo:       ______________________________________________________________
echo:
...
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "                       	      " %_Green% "Window Troubleshoot"
echo:       ______________________________________________________________
echo:                                              
...
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "                       	    " %_Green% "IDM License lifetime"
echo:       ______________________________________________________________
echo:                                                       
echo:          [1] Activate IDM                               
...
if %_erl%==3 call :_tog_Firewall&goto idm
...
set "reg=HKCU\SOFTWARE\DownloadManager /v FName /t REG_SZ /d "Chhai Developer"" & call :_rcont
